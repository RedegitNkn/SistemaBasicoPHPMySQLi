        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Editar/Eliminar</a>
                    </li>
                </ul>
                    ...
                    if($resultado -> num_rows > 0){
                        while($row = $resultado -> fetch_assoc()){?>
                            ...
                            <tr>
                                ...
                                <td><?php echo "<a href='editar.php?id=".$row['idproductos']."'>Editar</a>"?></td>
                                <td><?php echo "<a href='a-eliminar.php?id=".$row['idproductos']."'>Eliminar</a>"?></td>
                            </tr>
